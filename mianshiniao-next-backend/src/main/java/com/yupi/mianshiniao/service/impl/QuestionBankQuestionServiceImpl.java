...
import com.yupi.mianshiniao.mapper.QuestionBankQuestionMapper;
import com.yupi.mianshiniao.model.dto.questionBankQuestion.QuestionBankQuestionQueryRequest;
...
import com.yupi.mianshiniao.model.vo.QuestionBankQuestionVO;
...
public class QuestionBankQuestionServiceImpl extends ServiceImpl<QuestionBankQuestionMapper, QuestionBankQuestion> implements QuestionBankQuestionService {
    ...
    public void batchAddQuestionsToBankInner(List<QuestionBankQuestion> questionBankQuestions) {
        try {
            boolean result = this.saveBatch(questionBankQuestions);//批量操作
